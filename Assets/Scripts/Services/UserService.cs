...
namespace Services
{
    class UserService : Singleton<UserService>, IDisposable
    {
        ...
        public void SeedGameEnter(int characterIdx)
        {
            Debug.LogFormat("SeedGameEnter::characterIdx: {0}", characterIdx);
            NetMessage message = new NetMessage();
            message.Request = new NetMessageRequest();
        ...
        {
            Debug.LogFormat("UserSendGameLeave");
